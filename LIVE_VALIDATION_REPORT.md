...
**Endpoint:** `ws://REDACTED_IP:8043/api/v1/ws`  
...
# API endpoints
curl -s http://REDACTED_IP:8043/api/v1/health
curl -s http://REDACTED_IP:8043/api/v1/system | jq '.'
curl -s http://REDACTED_IP:8043/api/v1/array | jq '.'
curl -s http://REDACTED_IP:8043/api/v1/disks | jq '. | length'
curl -s http://REDACTED_IP:8043/api/v1/docker | jq '.'
curl -s http://REDACTED_IP:8043/api/v1/network | jq '. | length'
curl -s http://REDACTED_IP:8043/api/v1/shares | jq '. | length'
curl -s http://REDACTED_IP:8043/api/v1/ups | jq '.'
curl -s http://REDACTED_IP:8043/api/v1/gpu | jq '.'
