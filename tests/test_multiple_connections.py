...
Usage:
    python test_multiple_connections.py ws://REDACTED_IP:8043/api/v1/ws [num_clients] [duration]
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Example: python test_multiple_connections.py ws://REDACTED_IP:8043/api/v1/ws 12 60")
        sys.exit(1)
