...
**WebSocket Endpoint**: `ws://REDACTED_IP:8043/api/v1/ws`
...
### Test 1 Command
```bash
python3 test_multiple_connections.py ws://REDACTED_IP:8043/api/v1/ws 12 60
```

### Test 2 Command
```bash
python3 test_multiple_connections.py ws://REDACTED_IP:8043/api/v1/ws 20 30
```
