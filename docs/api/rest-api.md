...
// Configuration
const BASE_URL = "http://REDACTED_IP:8043/api/v1";
...
const client = new UnraidAPIClient("REDACTED_IP");
...
```bash
curl http://REDACTED_IP:8043/api/v1/health
```
...
```bash
curl http://REDACTED_IP:8043/api/v1/system
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/system/reboot
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/system/shutdown
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/array/stop
```
...
curl -X POST "http://REDACTED_IP:8043/api/v1/array/parity-check/start?correcting=true"
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/array/parity-check/stop
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/array/parity-check/pause
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/array/parity-check/resume
```
...
```bash
# By device
curl http://REDACTED_IP:8043/api/v1/disks/sdb

# By name
curl http://REDACTED_IP:8043/api/v1/disks/parity

# By ID
curl http://REDACTED_IP:8043/api/v1/disks/WUH721816ALE6L4_2CGV0URP
```
...
```bash
# Update share configuration
curl -X POST http://REDACTED_IP:8043/api/v1/shares/appdata/config \
...
```bash
curl http://REDACTED_IP:8043/api/v1/docker/jackett
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/docker/jackett/start
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/docker/jackett/stop
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/docker/jackett/restart
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/docker/jackett/pause
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/docker/jackett/unpause
```
...
```bash
curl http://REDACTED_IP:8043/api/v1/vm/windows-10
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/vm/windows-10/start
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/vm/windows-10/stop
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/vm/windows-10/restart
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/vm/windows-10/pause
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/vm/windows-10/resume
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/vm/windows-10/hibernate
```
...
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/vm/windows-10/force-stop
```
...
```bash
# Update system settings
curl -X POST http://REDACTED_IP:8043/api/v1/settings/system \
  -H "Content-Type: application/json" \
  -d '{
    "description": "Updated description",
    "server_name": "Cube"
...
```bash
curl http://REDACTED_IP:8043/api/v1/network/eth0/config
```
