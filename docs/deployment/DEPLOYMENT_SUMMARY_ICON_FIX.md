...
- Verified server is reachable at REDACTED_IP
...
### 1. Plugin List
1. Open Unraid Web UI: http://REDACTED_IP
...
### View Logs
```bash
ssh root@REDACTED_IP 'tail -f /var/log/unraid-management-agent.log'
```

### Check Service Status
```bash
ssh root@REDACTED_IP 'ps aux | grep unraid-management-agent | grep -v grep'
```

### Stop Service
```bash
ssh root@REDACTED_IP 'killall unraid-management-agent'
```

### Restart Service
```bash
ssh root@REDACTED_IP 'killall unraid-management-agent && nohup /usr/local/emhttp/plugins/unraid-management-agent/unraid-management-agent boot > /dev/null 2>&1 &'
```

### View Plugin Files
```bash
ssh root@REDACTED_IP 'ls -lah /usr/local/emhttp/plugins/unraid-management-agent/'
```
...
```bash
ssh root@REDACTED_IP 'killall unraid-management-agent && nohup /usr/local/emhttp/plugins/unraid-management-agent/unraid-management-agent > /dev/null 2>&1 &'
```
