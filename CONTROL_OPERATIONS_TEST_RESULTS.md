...
**Request:**
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/docker/bbb57ffa3c50/restart
```
...
**Request:**
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/docker/bbb57ffa3c50/stop
```
...
**Request:**
```bash
curl -X POST http://REDACTED_IP:8043/api/v1/docker/bbb57ffa3c50/start
```
